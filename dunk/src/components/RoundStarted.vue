...
.back-btn { border:none; background:#B23B3B; color:#fff; border-radius:8px; padding:9px 18px; font-weight:700; position:absolute; left:12px; top:12px; cursor:pointer; transition: opacity 200ms ease, background 200ms ease; }
.back-btn:disabled { opacity: 0.4; cursor: not-allowed; background: #6B2424; }
.close-btn {
  border: none;
...
.close-btn:disabled:hover { background: transparent; transform: translateY(-50%); }
